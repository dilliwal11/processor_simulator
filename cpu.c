...
printf("showRt: %d \n",current_branch_pc );
  ...
  rob[rob_count].rs1 = stage->rs1;
  rob[rob_count].rs2 = stage->rs2;
      ...
      if(cpu->regs_valid[iq[i].rs1])
            {
                for(int j =0;j<rob_count;j++){
                  ...
                  if (rob_check_ready_to_issue ){
                    ...
                    cpu->stage[INT_FU1].rs1_value = cpu->regs[iq[i].rs1];
                    cpu->stage[INT_FU1].imm = iq[i].imm;
      ...
      if(cpu->regs_valid[iq[i].rs1] && cpu->regs_valid[iq[i].rs2])
            {
                for(int j =0;j<rob_count;j++){
                    if(iq[i].rs1!=rob[j].rd && iq[i].rs2!=rob[j].rd) {
                      ...
                      cpu->stage[INT_FU1].rs2_value = cpu->regs[iq[i].rs2];
                        rob_check_ready_to_issue =0;
                    iq_removeItem (i);
                    break;
                  }
                ...
                for(int j =0;j<rob_count;j++){
                    if(iq[i].rs1!=rob[j].rd && iq[i].rs2!=rob[j].rd) {
                      ...
                      if (rob_check_ready_to_issue ){
                        ...
                        cpu->stage[MUL_FU1].rs1_value = cpu->regs[iq[i].rs1];
                        cpu->stage[MUL_FU1].rs2 = iq[i].rs2;
                        cpu->stage[MUL_FU1].rs2_value = cpu->regs[iq[i].rs2];
                        rob_check_ready_to_issue =0;
                        iq_removeItem (i);
                        break;
                      }
